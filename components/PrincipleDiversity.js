      ...
      <div className="container">
        <h2 className="diversity-statement__text">
          ...
          equal right in learning STEM. Minority Programmer will fit you right in amongst our diversed background of students.
            ...
            <div class="container text-center"><h2 class="cta-five__title">Join the International Network Today</h2><p class="cta-five__text">Only network where you feel like family and get the opportunity to support yours through STEM</p><a href="/register" class="thm-btn cta-five__btn">Join Today</a></div>
    </section>
    </section>
