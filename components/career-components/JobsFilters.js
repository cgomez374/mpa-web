    ...
    return (
        <div className="jobFilters">
            <div className="jobFilters-jobTitle job-filter-item ">
                ...
                <div className="job-filter-item-form">
                    ...
                    <div className="job-filter-item-form-options">
                        <button onClick={(e)=>closeForm(e.currentTarget)}>Cancel</button>
            ...
            <div className="jobFilters-salary job-filter-item">
                ...
                <div className="job-filter-item-form" >
                    <ul className="job-filter-item-form-list">
                        <li><input type="checkbox" name="datePosted" value="24 hours"/><span>$40,000+</span></li>
                        <li><input type="checkbox" name="datePosted" value="week"/><span>$60,000+</span></li>
                        <li><input type="checkbox" name="datePosted" value="month"/><span>$80,000+</span></li>
                        <li><input type="checkbox" name="datePosted" value="year"/><span>$100,000+</span></li>
                    </ul>
                    <div className="job-filter-item-form-options">
