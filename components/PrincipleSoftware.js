...
const PrincipleSoftware = () => {
    ...
    Minority Programmers specializes in emerging technologies. Our Software Engineers curriculum is full of courseware and experienced instructors who will mentor you throughout your journey. 
            ...
            <div class="container text-center"><h2 class="cta-five__title">Join the International Network Today</h2><p class="cta-five__text">Only network where you feel like family and get the opportunity to support yours through STEM</p><a href="/register" class="thm-btn banner-two__btn">Join Today</a></div>
    </section>
    </section>
