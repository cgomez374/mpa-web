...
export class MenteeQuestion8 extends Component {
    continue = e => {
        e.preventDefault();
        this.props.nextStep();
    }
    ...
    render() {
        ...
        return (
            <div className="tw-flex tw-flex-col tw-justify-between tw-font-redhat tw-bg-white tw-h-660px md:tw-h-auto tw-w-950px tw-p-24 md:tw-p-10  md:tw-my-20 tw-rounded-3xl tw-shadow-mentor tw-select-none">
                <div>
                    <form>
                        <h1 className="tw-font-bold tw-text-black tw-text-5xl md:tw-w-full tw-w-max md:tw-text-center md:tw-leading-snug tw-select-none">What are you looking for in a mentor</h1>
                        <p className="tw-mb-8 tw-mt-4 tw-text-black tw-text-xl tw-italic md:tw-text-center">Commitment</p>
                        <div className="tw-flex tw-flex-row md:tw-flex-col">
                            ...
                            <label className="tw-w-6/12 md:tw-w-full" htmlFor="SecondSelect">
                                <input
                                    ...
                                    name="lookingForComm"
                                    onChange={handleChange('lookingForComm')}
                                    defaultValue="1-5 hours"
                                    defaultChecked={values.lookingForComm === '1-5 hours'}
                                />
                                <div className="tw-flex tw-flex-initial tw-flex-col tw-justify-center tw-text-gray-400 tw-text-opacity-70 tw-h-20 tw-text-center tw-bg-white input-area tw-py-3 tw-px-3 tw-border-4 tw-border-gray-300 tw-border-opacity-50 tw-rounded-2xl tw-my-2 tw-ml-3 md:tw-ml-0 tw-text-3xl tw-cursor-pointer label-checked:tw-bg-NavDark label-checked:tw-font-bold label-checked:tw-text-white label-checked:tw-border-NavDark">1-5 hours</div>
                            </label>
                        </div>
                        <div className="tw-flex tw-flex-row md:tw-flex-col">
                            <label className="tw-w-6/12 md:tw-w-full" htmlFor="ThirdSelect">
                                ...
                                <input
                                    ...
                                    name="lookingForComm"
                                    onChange={handleChange('lookingForComm')}
                                    defaultValue="6-12 hours"
                                    defaultChecked={values.lookingForComm === '6-12 hours'}
                                />
                                <div className="tw-flex tw-flex-initial tw-flex-col tw-justify-center tw-text-gray-400 tw-text-opacity-70 tw-h-20 tw-text-center tw-bg-white input-area tw-py-3 tw-px-3 tw-border-4 tw-border-gray-300 tw-border-opacity-50 tw-rounded-2xl tw-my-2 tw-ml-3 md:tw-ml-0 tw-text-3xl tw-cursor-pointer label-checked:tw-bg-NavDark label-checked:tw-font-bold label-checked:tw-text-white label-checked:tw-border-NavDark">6-12 hours</div>
                            </label>
                            <label className="tw-w-6/12 md:tw-w-full" htmlFor="FourthSelect">
                                <input
                                    ...
                                    defaultChecked={values.lookingForComm === 'No preference'}
                                />
                                <div className="tw-flex tw-flex-initial tw-flex-col tw-justify-center tw-text-gray-400 tw-text-opacity-70 tw-h-20 tw-text-center tw-bg-white input-area tw-py-3 tw-px-3 tw-border-4 tw-border-gray-300 tw-border-opacity-50 tw-rounded-2xl tw-my-2 tw-ml-3 md:tw-ml-0 tw-text-3xl tw-cursor-pointer label-checked:tw-bg-NavDark label-checked:tw-font-bold label-checked:tw-text-white label-checked:tw-border-NavDark">No preference</div>
                            </label>
                        </div>
                ...
                <div className="tw-w-full tw-flex tw-flex-col">
                    ...
                    <div className="tw-w-full tw-bg-gradient-to-r tw-from-FFC700 tw-via-FF655B tw-to-FF00B8 tw-h-2 tw-rounded-2xl tw-relative">
                        <div className={`tw-bg-gray-300 tw-h-2 tw-rounded-2xl tw-absolute tw-right-0 tw-w-${values.step}/13`}></div>
                    </div>
                </div>
            </div>
        )
...
export default MenteeQuestion8
