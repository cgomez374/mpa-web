                ...
                <div className="container step__completed-details">
                    ...
                    <div className="step__details-box">
                        <div className="row">
                            ...
                            <div className="col"><p>{billingDetails.payer.name.given_name}</p></div>
                        </div>
                        <div className="row">
                        ...
                        <div className="row">
                            ...
                            <div className="col"><p>{new Date(billingDetails.create_time).toLocaleString()}</p></div>
                        </div>
                        <div className="row">
                            <div className="col"><p>Payment method:</p></div>
                            <div className="col"><p>PayPal</p></div>
                        </div>
                    </div>
                </div>
