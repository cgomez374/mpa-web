                        ...
                        <div className="container">
                            <div className="row no-gutters">
                                <div className="col-xl-12">
                                    <h3 className="banner-two__title banner-two__light-color">Minority Programmers <br />
                                        Association</h3>
                                        <p className="banner-two__tag-line">Code, Culture, Community</p>
                                    <a href="#" className="thm-btn banner-two__btn">Start Your Journey</a>
                                </div>
                            </div>
                        </div>
                    </div>
