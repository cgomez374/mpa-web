                ...
                <div className="companyDetails-wrapper">
                    ...
                    <div className="companyDetails-container">
                        ...
                        <div className="companyDetails-container-info">
                            <h2 className="companyDetails-container-info-name">{company.name}</h2>
                            <div className="companyDetails-container-info-relationship"><strong>{company.relation_type}</strong> of Minority Programmers Association since <strong>{company.mpa_relationship_started}</strong></div>
                            <div className="companyDetails-container-info-extra">
                                <div className="companyDetails-container-info-extra-links">
                                    ...
                                    <div className="companyDetails-container-info-extra-links-social">
                                        <a href={company.social_media_links.fb}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="31.5" height="31.5" viewBox="0 0 31.5 31.5">
                                    ...
                                    <div className="companyDetails-container-info-extra-links-info">
                                        ...
                                        <span>Since: {company.started_at}</span>
                                    </div>
                                </div>
                        ...
                        <div className="companyDetails-container-description">
                            ...
                            <p className="companyDetails-container-description-paragraph">{company.description}</p>
                        </div>
